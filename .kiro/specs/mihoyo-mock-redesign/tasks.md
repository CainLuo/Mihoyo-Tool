...
- [x] 1. 创建 MockServiceBase
  - [x] 1.1 新建 `core/src/main/ets/network/v2/mock/MockServiceBase.ets`，继承 `MihoyoApiService`，构造函数注入 `common.UIAbilityContext`
...
- [x] 2. 创建 MihoyoAccountMockService
  - [x] 2.1 新建 `core/src/main/ets/network/v2/mock/MihoyoAccountMockService.ets`，继承 `MockServiceBase`
...
- [x] 3. 创建 GenshinMockService
  - [x] 3.1 新建 `core/src/main/ets/network/v2/mock/GenshinMockService.ets`，继承 `MockServiceBase`
...
- [x] 4. 创建 StarRailMockService
  - [x] 4.1 新建 `core/src/main/ets/network/v2/mock/StarRailMockService.ets`，继承 `MockServiceBase`
...
- [x] 5. 创建 ZZZMockService
  - [x] 5.1 新建 `core/src/main/ets/network/v2/mock/ZZZMockService.ets`，继承 `MockServiceBase`
...
- [x] 6. 创建 SignMockService
  - [x] 6.1 新建 `core/src/main/ets/network/v2/mock/SignMockService.ets`，继承 `MockServiceBase`
...
- [x] 9. 端到端验证（Mock 环境）
  - [x] 9.1 确认 `EntryAbility.onCreate` 调用 `CoreInitializerV2.initCore({ isMock: true, context })` 时，各 Repository 持有的是 Mock Service 实例
