...
function renderHome(w, h) {
  ...
  function accountSection(nickname, avatarUrl, gameCount, cards) {
    return (
      '<div style="margin-bottom:20px">' +
      '<div style="display:flex;align-items:center;gap:8px;padding:8px 0 12px">' +
      '<img src="' +
      avatarUrl +
      '" style="width:28px;height:28px;border-radius:8px;object-fit:cover;flex-shrink:0;border:1px solid ' +
      c.primary +
